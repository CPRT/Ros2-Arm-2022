...
class ArmNode(Node):
    def __init__(self):
        ...
        self.HOME_SETPOINT_MOTORANGLES_RAD = [self.declare_parameter("~m0_home", 0), self.declare_parameter("~m1_home", 0), self.declare_parameter("~m2_home", 0),
                                              self.declare_parameter("~m3_home", 0), self.declare_parameter("~m4_home", 0),self.declare_parameter("~m5_home", 0)]
        ...
        self.pidControllers = [ 
            PidController(self.declare_parameter("~m0_mI", False), self.declare_parameter("~m0_p", 0), self.declare_parameter("~m0_i", 0), self.declare_parameter("~m0_d", 0), self.declare_parameter("~m0_f", 0), self.declare_parameter("~m0_iZ", 0), self.declare_parameter("~m0_maxVoltage", 12)),
            PidController(self.declare_parameter("~m1_mI", False), self.declare_parameter("~m1_p", 0), self.declare_parameter("~m1_i", 0), self.declare_parameter("~m1_d", 0), self.declare_parameter("~m1_f", 0), self.declare_parameter("~m1_iZ", 0), self.declare_parameter("~m1_maxVoltage", 12)),
            PidController(self.declare_parameter("~m2_mI", False), self.declare_parameter("~m2_p", 0), self.declare_parameter("~m2_i", 0), self.declare_parameter("~m2_d", 0), self.declare_parameter("~m2_f", 0), self.declare_parameter("~m2_iZ", 0), self.declare_parameter("~m2_maxVoltage", 12)),
            PidController(self.declare_parameter("~m3_mI", False), self.declare_parameter("~m3_p", 0), self.declare_parameter("~m3_i", 0), self.declare_parameter("~m3_d", 0), self.declare_parameter("~m3_f", 0), self.declare_parameter("~m3_iZ", 0), self.declare_parameter("~m3_maxVoltage", 12)),
            PidController(self.declare_parameter("~m4_mI", False), self.declare_parameter("~m4_p", 0), self.declare_parameter("~m4_i", 0), self.declare_parameter("~m4_d", 0), self.declare_parameter("~m4_f", 0), self.declare_parameter("~m4_iZ", 0), self.declare_parameter("~m4_maxVoltage", 12)),
            PidController(self.declare_parameter("~m5_mI", False), self.declare_parameter("~m5_p", 0), self.declare_parameter("~m5_i", 0), self.declare_parameter("~m5_d", 0), self.declare_parameter("~m5_f", 0), self.declare_parameter("~m5_iZ", 0), self.declare_parameter("~m5_maxVoltage", 12))]

        self.pidControllers[0].setSoftLimits(self.declare_parameter("~m0_sL", 0), self.declare_parameter("~m0_sH", 0))
        self.pidControllers[1].setSoftLimits(self.declare_parameter("~m1_sL", 0), self.declare_parameter("~m1_sH", 0))
        self.pidControllers[2].setSoftLimits(self.declare_parameter("~m2_sL", 0), self.declare_parameter("~m2_sH", 0))
        self.pidControllers[3].setSoftLimits(self.declare_parameter("~m3_sL", 0), self.declare_parameter("~m3_sH", 0))
        self.pidControllers[4].setSoftLimits(self.declare_parameter("~m4_sL", 0), self.declare_parameter("~m4_sH", 0))
        self.pidControllers[5].setSoftLimits(self.declare_parameter("~m5_sL", 0), self.declare_parameter("~m5_sH", 0))

        self.gearReduction = [self.declare_parameter("~m0_encGearReduction", 1), self.declare_parameter("~m1_encGearReduction", 1), self.declare_parameter("~m2_encGearReduction", 1),
                              self.declare_parameter("~m3_encGearReduction", 1), self.declare_parameter("~m4_encGearReduction", 1), self.declare_parameter("~m5_encGearReduction", 1)]

        self.encoderTicksPerRotation = [self.declare_parameter("~m0_eT", 0), self.declare_parameter("~m1_eT", 0), self.declare_parameter("~m2_eT", 0),
                                        self.declare_parameter("~m3_eT", 0), self.declare_parameter("~m4_eT", 0), self.declare_parameter("~m5_eT", 0)]

        self.encoderOffset = [self.declare_parameter("~m0_eO", 0), self.declare_parameter("~m1_eO", 0), self.declare_parameter("~m2_eO", 0),
                              self.declare_parameter("~m3_eO", 0), self.declare_parameter("~m4_eO", 0), self.declare_parameter("~m5_eO", 0)]
        ...
        for direction in self.invertEncoderDirection:
            name = "~m" + str(i) + "_eI"
            if (self.declare_parameter(name, False)):
                direction = -1
            i += 1
        ...
        self.addresses = [int(addr) for addr in self.declare_parameter("~addresses", "131,132,133").value.split(",")]
        ...
        if any((addr > 0x87 or addr < 0x80 for addr in self.addresses)):
            ...
            # KEEP? rospy.signal_shutdown("Address out of range")
        ...
        self.cmd_arm_state_subscriber = self.create_subscription(
            Int64, "cmd_arm_state", self.arm_state_callback, 10)

        self.cmd_arm_subscriber = self.create_subscription(
            PoseStamped, "cmd_arm", self.cmd_arm_callback, 10)
        ...
        self.temperature_timer_ = self.create_timer(
            1, self.runMainLoop) # TODO: CHANGE THIS TIME TO A DECLARE PARAMETER
    ...
    def callback_liveTune(self, message: Int64):
...
4. Msg files (Change all the Int64)
