...
bool arm_interfaces__msg__six_floats__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_interfaces.msg._six_floats.SixFloats", full_classname_dest, 40) == 0);
  }
  arm_interfaces__msg__SixFloats * ros_message = _ros_message;
  {  // m0
...
{
  /* NOTE(esteve): Call constructor of SixFloats */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_interfaces.msg._six_floats");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SixFloats");
